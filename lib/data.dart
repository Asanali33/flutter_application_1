...
List<Map<String, dynamic>> phoneProducts = [
  ...
  // APPLE
  {
    ...
    'description':
        'Титан корпусы, A17 Pro чипі және кәсіби деңгейдегі 48 Мп камера жүйесі.',
    'specs': {
  ...
  },
  {
    ...
    'description':
        'Күнделікті қолданысқа арналған сенімді әрі жылдам смартфон.',
    'specs': {
      'screen': '6.1" OLED',
      'cpu': 'A15 Bionic',
      'battery': '3240 mAh',
  ...
  },
  {
    ...
    'specs': {
      'screen': 'N/A',
      'cpu': 'H2 Chip',
      'battery': '6h (30h total)',
      'camera': 'N/A',
    },
    'variants': [
      {'ram': 'White', 'price': 66700},
    ],
  },
  {
    ...
    'description':
        'Экстремалды спорт пен белсенді өмір салтына арналған ең мықты сағат.',
    'specs': {
      'screen': '1.92" LTPO OLED',
      'cpu': 'S10 SiP',
      'battery': '36-72h',
      'camera': 'N/A',
    },
    'variants': [
      {'ram': 'Titanium', 'price': 450000},
    ],
  },
  ...
  // SAMSUNG
  {
    ...
    'description': 'Galaxy AI мүмкіндіктеді, 200 Мп камера және S Pen.',
    'specs': {
  ...
  },
  {
    ...
    'variants': [
      {'ram': '128GB', 'price': 115000},
      {'ram': '256GB', 'price': 130000},
    ],
  },
  {
    'name': 'Poco F6 Pro',
  ...
  // NOUTBOOKTAR
  {
    ...
    'specs': {
      'screen': '16" QHD 165Hz',
      'cpu': 'Ryzen 7 / RTX 4060',
      'battery': '80Wh',
      'camera': '720p HD',
    },
    'variants': [
      {'ram': '16GB/512GB', 'price': 680000},
    ],
  },
  {
    ...
    'description':
        'Әскери деңгейдегі төзімділік пен қуатты ойын мүмкіндіктері.',
    'specs': {
  ...
  // БАСҚАЛАР ЖӘНЕ АКСЕССУАРЛАР
  {
    ...
    'description':
        'JBL Pure Bass дыбысы және 57 сағатқа дейін жұмыс істейтін батарея.',
    'specs': {
      'screen': 'N/A',
      'cpu': 'Bluetooth 5.3',
      'battery': '57h Playback',
      'camera': 'N/A',
    },
    'variants': [
      {'ram': 'Blue', 'price': 22000},
    ],
  },
  {
    'name': 'GERLAX GH-34',
    ...
    'description':
        'Күнделікті қолданысқа арналған қолжетімді әрі ыңғайлы құлаққап.',
    'specs': {
      'screen': 'N/A',
      'cpu': 'Standard Driver',
      'battery': 'Up to 10h',
  ...
  },
  {
    ...
    'description':
        'Геймерлерге арналған аңызға айналған жайлылық пен көлемді дыбыс.',
    'specs': {
      'screen': 'N/A',
      'cpu': '53mm Drivers',
      'battery': 'Wired',
  ...
  },
  {
    ...
    'description':
        'Аңызға айналған дыбыс және 100 сағаттан астам сымсыз жұмыс уақыты.',
    'specs': {
      'screen': 'N/A',
      'cpu': 'Custom Driver',
      'battery': '100h+ Wireless',
      'camera': 'N/A',
    },
    'variants': [
      {'ram': 'Black', 'price': 85000},
    ],
  },
  {
    'name': 'Hoco W25',
